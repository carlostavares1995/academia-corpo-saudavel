    ...
    <script>
        var tableLista = $('#lista').DataTable({
            ...
            columns: [
                ...
                {data: 'data_nascimento', name: 'fisicas.data_nascimento'},
                {
                    "mRender": function (data, type, full) {
                        var buttons = "";

                        buttons += '<a href="/aluno/edit/' + full["id"] + '" class="btn btn-sm btn-primary" title="Editar"><i class="fa fa-edit"></i> </a>';
