...
@section('content_header')
    <h1 class="m-0 text-dark">Listagem de Tinys</h1>
@stop
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-footer text-center">
                    <a type="button" class="btn btn-primary" href="/tiny-mce/create">
                        <i class="fa fa-plus"></i> Cadastrar Tiny MCE
                    </a>
                </div>
            </div>
        </div>
            ...
            columns: [
                {data: 'content', name: 'tinys.content'},
                {
                    "mRender": function (data, type, full) {
                        ...
                        buttons += '<a href="/tiny-mce/edit/' + full["id"] + '" class="btn btn-sm btn-primary" title="Editar"><i class="fa fa-edit"></i> </a>';
